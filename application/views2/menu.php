...
<aside class="main-sidebar sidebar-light-info elevation-4 fadeInLeft" style="background-color: #395169;">
  <!-- Brand Logo -->
    
    <a href="<?php echo base_url(); ?>" class="brand-link " style="background-color: #293D55;">
