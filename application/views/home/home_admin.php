            ...
            <div class="card card-navy card-outline">
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card card-navy card-outline">
                    <!-- <div class="card card-navy card-oufas fa-spin fa-globe text-whitetline"> -->
                      <div class="card-header">
                        <h3 class="card-title text-navy" style="text-shadow: 2px 2px 4px #fff;"><i class="fas fa-users-class"></i> DAFTAR GRAFIK INFORMASI ALUMNI</h3>
                  ...
                  <div class="col-md-6">
                    <div class="card card-navy card-outline">
                      <div class="card-header">
                        <h3 class="card-title text-navy" style="text-shadow: 2px 2px 4px #fff;"><i class="fas fa-users-class"></i> PENDATAAN ALUMNI</h3>
                        <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                              </button>
                        </div>
