...
<head>
  ...
  <title>SMK Kesehatan Logos | Proschool</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-purple navbar-light" style="background-color: white;">
      ...
      <div class="btn-group btn-group-sm">
                    <span class="btn bg-navy icon text-white-50">
                      <i class="fas fa-calendar-alt text-white"></i>
                    </span>
                    <span class="btn bg-white brand-text font-weight-light text-white text-uppercase"><b>TA : <?php echo $tahun_ajaran->tahun_ajaran.' | Semester '.$tahun_ajaran->semester; ?></b></span>
                  <a href="<?=base_url('logout')?>"  class="btn bg-navy btn-icon-split"">
