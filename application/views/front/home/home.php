						...
						<div class="card card-navy">
							<div class="card-header">
                                ...
                                <img class="profile-user-img img-fluid img-circle"
									...
									<center><h4 class="m-0 text-white" style="text-shadow: 0px 0px 0px white; ">Form Login Alumni</h4></center>
							</div>
							<div class="card-body box-profile">
								<form action="<?php echo base_url(); ?>app/save_login" method="post">
										...
										<li class="list-group-item">
											<div class="input-group mb-3">
												<div class="input-group-prepend">
													<span class="input-group-text"><i class="fas fa-envelope text-navy"></i></span>
												</div>
												<input type="email" class="form-control" name="email" placeholder="Email" required>
											</div>
											<div class="input-group mb-3">
												<div class="input-group-prepend">
													<span class="input-group-text"><i class="fas fa-eye text-navy"></i></span>
												</div>
									...
									<button class="btn bg-navy btn-block"> <i class="fad fa-sign-in"></i><b> L O G I N</b></button>
									<a class="nav-link 	text-muted text-right" href="#settings" data-toggle="tab"><i class="fa fa-user text-navy"> </i> Registrasi Alumni</a>
								</form>
							</div>
							<!-- /.card-body -->
						</div>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header p-2">
								<ul class="nav nav-pills bg-navy">
										...
										<form class="form-horizontal" action="<?php echo base_url(); ?>app/save_registrasi" method="post">
											...
											<div class="form-group row">
												<div class="offset-sm-8 col-sm-4">
													<button type="submit" class="btn bg-navy btn-block"><i class="fa fa-save"> </i> DAFTAR</button>
												</div>
											</div>
										</form>
									</div>
					...
					<div class="col-md-3">
						<div class="card card-navy">
							...
							<div class="card-body text-navy">
								...
								<h6><strong><?php echo $profile->pr_nama ?> <br>
										NPSN : <?php echo $profile->pr_npsn ?></strong></h6>	</center>
								</p>
								...
								<p class="text-muted">
									<a class="text-muted" href="#" target="_blank"><i class="fas fa-phone-office text-warning"></i><?php echo $profile->pr_telepon ?></a><br>
									...
									<a class="text-muted" href="#" target="_blank"><i class="fas fa-envelope text-navy"></i> <?php echo $profile->pr_email ?></a><br>
									<!-- <a class="text-muted" href="#" target="_blank"><i class="fas fa-envelope text-navy"></i> <?php echo $email ?></a><br> -->
									<a class="text-muted" href="https://proschool.id" target="_blank"><i class="fab fa-internet-explorer text-navy"></i> www.smkkesehatanlogos.sch.id</a><br>
									<!-- <a class="text-muted" href="#" target="_blank"><i class="fab fa-internet-explorer text-navy"></i> <?php echo $website ?></a><br>	 -->
								</p>

								<hr>
								<strong><i class="fas fa-map-marker-alt mr-1"></i> Alamat</strong>
								<p class="text-muted"><?php echo $profile->pr_alamat.' | '.$profile->pr_kodepos; ?></p>
