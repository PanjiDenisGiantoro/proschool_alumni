...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>ALUMNI | <?php echo $profile->pr_nama; ?></title>
	<link rel="shortcut icon" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/panel/upload/profile'.$sekolah->logo; ?>" type="image/x-icon">
	<!-- Font Awesome Icons -->
...
<div class="wrapper">
	...
	<nav class="main-header navbar navbar-expand-md navbar-light navbar-navy">
        ...
        <span class="brand-text font-weight-light text-white"><strong><?php echo $profile->pr_nama; ?></strong></span>
